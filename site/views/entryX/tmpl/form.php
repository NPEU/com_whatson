...
<form action="<?php echo $route; ?>" method="post" name="whatson_form" id="<?php echo $form_id; ?>" class="">
<?php
...
?>
    <fieldset class="three-quarters push--one-quarter">
        ...
        <?php endif; ?><?php endforeach; ?>
        <?php /*
        <button class="btn" type="submit"><?php echo JText::_('COM_WHATSON_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo JRoute::_('index.php?option=com_whatson'); ?>"><?php echo JText::_('JCANCEL') ?></a>
        */ ?>
        <button class="btn" type="submit" onclick="return Joomla.submitbutton('entry.save')"><?php echo JText::_('COM_WHATSON_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo JRoute::_('index.php?option=com_whatson'); ?>" onclick="return Joomla.submitbutton('entry.cancel')"><?php echo JText::_('JCANCEL') ?></a>
    </fieldset>
</form>
