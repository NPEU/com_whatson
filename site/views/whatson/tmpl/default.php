...
?>
<p>
<a href="<?php echo JRoute::_('index.php?option=com_whatson&task=entry.add'); ?>">Add new</a>
</p>
<table class="table table-striped table-hover" id="<?php echo $table_id; ?>">
    <thead>
        <tr>
            <?php /*<th width="2%"><?php echo JText::_('COM_WHATSON_NUM'); ?></th>
            <th width="4%">
                <?php echo JHtml::_('grid.checkall'); ?>
            </th>*/ ?>
            <th width="50%">
                <?php echo JText::_('COM_WHATSON_RECORDS_TITLE'); ?>
            </th>
            <th width="40%">
                <?php echo JText::_('COM_WHATSON_RECORDS_ALIAS'); ?>
            </th>
            <th width="10%">
                <?php echo JText::_('COM_WHATSON_RECORDS_ACTIONS'); ?>
            </th>
            <?php /*<th width="10%">
                <?php echo JHtml::_('grid.sort', 'COM_WHATSON_PUBLISHED', 'published', $listDirn, $listOrder); ?>
            </th>
            <th width="4%">
                <?php echo JHtml::_('grid.sort', 'COM_WHATSON_ID', 'id', $listDirn, $listOrder); ?>
            </th>*/ ?>
        </tr>
    </thead>
    <tbody>
        <?php if (!empty($this->items)) : ?>
            <?php foreach ($this->items as $i => $row) :
                ...
                $is_own = false;
                if ($this->user->authorise('core.edit.own', 'com_whatson') && ($this->user->id == $row->created_by)) {
                    $is_own = true;
                }
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo $view_link; ?>" title="<?php echo JText::_('COM_WHATSON_VIEW_RECORD'); ?>">
                            <?php echo $row->title; ?>
                        </a>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="<?php echo $edit_link; ?>" title="<?php echo JText::_('COM_WHATSON_EDIT_RECORD'); ?>">
                    ...
                    <?php /*<td align="center">
                        <?php echo JHtml::_('jgrid.published', $row->published, $i, 'whatson.', true, 'cb'); ?>
                    </td>
                    <td align="center">
                        <?php echo $row->id; ?>
                    </td>*/ ?>
...
<p>
    <a href="<?php $altview = 'alt'; echo JRoute::_('index.php?option=com_whatson&view=' . $altview); ?>">Sample alternative view</a>
</p>
<?php /* You can include the form  here if you want like this:
include JPATH_SITE . '/components/com_whatson/views/entry/tmpl/form.php';
*/?>
