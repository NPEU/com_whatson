...
/**
 * Entry Component Controller
 *
 * Used to handle the http POST from the front-end form which allows users to enter a new entry
 */
class EntryController extends FormController
{
    ...
    public function __construct($config = array())
    {
        ...
        $this->view_item = $input->get("view", "entry", "string");
    ...
    public function cancel($key = null)
    {
        ...
        /*$this->setRedirect(
            ...
            Text::_('COM_WHATSON_ADD_CANCELLED')
        );*/
        ...
        if ($recordId) {
            ...
            $message = Text::_('COM_WHATSON_EDIT_CANCELLED');
        } else {
            $url = 'index.php?option=' . $this->option . '&view=' . $this->view_list . $this->getRedirectToListAppend();
            $message = Text::_('COM_WHATSON_ADD_CANCELLED');
        }
    ...
    /*
     * Function handing the save for adding a new whatson record
     ...
     * @since   1.5
     */
    public function getModel($name = 'Form', $prefix = 'Whatson', $config = ['ignore_request' => true])
    {
