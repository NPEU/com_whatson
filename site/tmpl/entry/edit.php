...
<form action="<?php echo $uri; ?>" method="post" name="whatson_form" id="<?php echo $form_id; ?>" class="">
    <?php
    ...
    <fieldset>
        ...
        <?php endif; ?><?php endforeach; ?>
        <?php /*
        <button class="btn" type="submit"><?php echo Text::_('COM_WHATSON_SUBMIT_LABEL'); ?></button>
        <a class="btn" href="<?php echo Route::_('index.php?option=com_whatson'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        */ ?>
        <button type="submit" name="task" value="entry.save"><strong><?php echo Text::_('COM_WHATSON_SUBMIT_LABEL'); ?></strong></button>
        <?php if (!empty($item_id)) : ?>
        <button type="submit" name="task" value="entry.cancel"><?php echo Text::_('JCANCEL') ?></button>
        <?php else : ?>
        <a href="<?php echo Route::_('index.php?option=com_whatson&task=entry.abort'); ?>"><?php echo Text::_('JCANCEL') ?></a>
        <?php endif; ?>
    </fieldset>
</form>
