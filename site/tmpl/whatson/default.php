...
$language->load('com_whatson', JPATH_ADMINISTRATOR . '/components/com_whatson');
...
$doc->addStyleSheet('/components/com_whatson/tmpl/whatson/whatson.min.css');
$doc->addScript('/components/com_whatson/tmpl/whatson/whatson.min.js');
...
#echo '<pre>'; var_dump($inputs_fieldset); echo '</pre>'; exit;
