...
namespace NPEU\Component\Whatson\Administrator\View\Whatson;
...
class HtmlView extends BaseHtmlView {
    ...
    */
    ...
    function display($tpl = null) {
        ...
        $this->canDo = ContentHelper::getActions('com_whatson');
    ...
    {
        $title = Text::_('COM_WHATSON_MANAGER_RECORDS', 'smiley-2');
        ...
        /*if ($this->canDo->get('core.create')) {
            ToolBarHelper::addNew('entry.add', 'JTOOLBAR_NEW');
        }
        if ($this->canDo->get('core.edit')) {
            ToolBarHelper::editList('entry.edit', 'JTOOLBAR_EDIT');
        }*/


        /*if (!$this->isEmptyState && ($this->canDo->get('core.edit.state'))) {
            if ($this->canDo->get('core.delete')) {
                //ToolBarHelper::deleteList('', 'whatson.delete', 'JTOOLBAR_DELETE');
                if ($this->state->get('filter.published') != -2) {
                    ToolBarHelper::deleteList('', 'whatson.trash', 'JTOOLBAR_DELETE');
                }
            }

            if ($this->canDo->get('core.edit') || Factory::getApplication()->getIdentity()->authorise('core.manage', 'com_checkin')) {
                ToolBarHelper::checkin('whatson.checkin');
            }
        ...
        /*if (!$this->isEmptyState && $this->state->get('filter.published') == -2 && $this->canDo->get('core.delete')) {
            ToolBarHelper::deleteList('', 'whatson.delete', 'JTOOLBAR_EMPTY_TRASH');
            /*$toolbar->delete('whatson.delete', 'JTOOLBAR_EMPTY_TRASH')
        ...
        if ($this->canDo->get('core.admin')) {
            ...
            ToolBarHelper::preferences('com_whatson');
        }
    }
}