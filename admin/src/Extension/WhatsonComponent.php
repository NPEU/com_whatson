...
namespace NPEU\Component\Whatson\Administrator\Extension;
...
class WhatsonComponent extends MVCComponent implements
    RouterServiceInterface, BootableExtensionInterface
{
    ...
    {
        $this->getRegistry()->register('whatsonsadministrator', new AdministratorService);
    }
